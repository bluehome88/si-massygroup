    ...
    <form action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" enctype="multipart/form-data">
      <div class="careerFormBox">
        ...
        <div class="d-flex align-items-center flex-wrap nameInput">
          ...
          <div>
            <input type="text" name="talent_network_applicants[state]" placeholder="State" required />
          </div>
        </div>
        <div class="d-flex align-items-center flex-wrap nameInput">
          <div>
            <input type="text" name="talent_network_applicants[zip_code]" placeholder="Zip Code" required />
          </div>
          <div>
      ...
      <div class="container d-flex justify-content-center" style="margin-bottom: 56px;">
        <button type="submit" class="continue talentSubmit">Submit</button>
      </div>
    </form>
  </div>
